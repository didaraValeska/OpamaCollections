...
public class SapiActivity extends AppCompatActivity {
    ...
    public void decrement(View view) {
        if(jumlah == 0) {
            Toast.makeText(SapiActivity.this, "Tidak bisa kurang dari 0",
    ...
    public void submitOrder(View view) {
        ...
        int sapiPrice = calculatePrice(hasWisuda, hasKado);
        //call createOrderSummary method
        String priceMessage = createOrderSummary(name, alamat, hp, sapiPrice, optionWisuda, optionKado);
