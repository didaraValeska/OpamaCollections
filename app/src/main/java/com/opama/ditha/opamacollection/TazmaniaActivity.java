...
public class TazmaniaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tazmania);
    }

    public void decrement(View view) {
        if(jumlah == 0) {
            Toast.makeText(TazmaniaActivity.this, "Tidak bisa kurang dari 0",
    ...
    public void submitOrder(View view) {
        ...
        int tazmaniaPrice = calculatePrice(hasWisuda, hasKado);
        //call createOrderSummary method
        String priceMessage = createOrderSummary(name, alamat, hp, tazmaniaPrice, optionWisuda, optionKado);
