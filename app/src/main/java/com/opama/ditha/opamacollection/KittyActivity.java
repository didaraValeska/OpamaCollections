...
public class KittyActivity extends AppCompatActivity {
    ...
    public void decrement(View view) {
        if(jumlah == 0) {
            Toast.makeText(KittyActivity.this, "Tidak bisa kurang dari 0",
     ...
     * @param alamat  for input address
     * @param hp  for input phone numb
    ...
    public void submitOrder(View view) {
        ...
        int kittyPrice = calculatePrice(hasWisuda, hasKado);
        //call createOrderSummary method
        String priceMessage = createOrderSummary(name, alamat, hp, kittyPrice, optionWisuda, optionKado);
