...
public class MickeyActivity extends AppCompatActivity {
    ...
    public void decrement(View view) {
        if(jumlah == 0) {
            Toast.makeText(MickeyActivity.this, "Tidak bisa kurang dari 0",
    ...
    public void submitOrder(View view) {
        ...
        int mickeyPrice = calculatePrice(hasWisuda, hasKado);
        //call createOrderSummary method
        String priceMessage = createOrderSummary(name, alamat, hp, mickeyPrice, optionWisuda, optionKado);
