...
public class MinnieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minnie);
    }

    public void decrement(View view) {
        if(jumlah == 0) {
            Toast.makeText(MinnieActivity.this, "Tidak bisa kurang dari 0",
    ...
    public void submitOrder(View view) {
        ...
        int minniePrice = calculatePrice(hasWisuda, hasKado);
        //call createOrderSummary method
        String priceMessage = createOrderSummary(name, alamat, hp, minniePrice, optionWisuda, optionKado);
